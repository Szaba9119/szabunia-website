    ...
    <section id="o-mnie" className="py-12 md:py-24 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Photo */}
          <AnimatedSection>
            <div className="relative aspect-[3/4] md:aspect-square lg:aspect-[3/4] rounded-2xl overflow-hidden bg-border dark:bg-dark-card">
              <Parallax distance={PARALLAX.subtle} direction="up" className="absolute inset-0">
                <div className="absolute inset-0 scale-[1.15]">
                  <Image
                    ...
                    sizes="(max-width: 768px) 92vw, (max-width: 1024px) 48vw, 520px"
                    quality={80}
                    placeholder="blur"
