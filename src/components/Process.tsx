...
const steps = [
  ...
  {
    num: 3,
    // 23.09.2026 (decyzja Marcina, audyt L2): było „Selekcja: w ciągu 48 godzin dostajesz
    // galerię online i zaznaczasz w niej ujęcia do retuszu”, czyli przebieg sesji
    // portretowej. Strona główna prowadzi eventami (ok. 30 gotowych zdjęć na godzinę,
    // bez selekcji po stronie klienta), więc krok jest uniwersalny.
    title: "Obróbka",
    desc: "Wybieram najlepsze ujęcia, obrabiam materiał i przygotowuję go do publikacji.",
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
