...
export default function MobileFAB() {
  ...
  const iconBtn =
    "w-12 h-12 rounded-full bg-white dark:bg-dark-card border border-border dark:border-dark-border shadow-lg shadow-navy/10 flex items-center justify-center text-navy dark:text-white";

  return (
    <div
      className="fixed left-5 z-40 flex items-center gap-2 md:hidden transition-[bottom] duration-300"
    ...
    >
      ...
      <a href={`tel:${PHONE}`} aria-label="Zadzwoń" className={iconBtn}>
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
