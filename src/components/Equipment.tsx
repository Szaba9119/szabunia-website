        ...
        <AnimatedSection delay={0.32}>
          <div className="mt-4 max-w-4xl mx-auto bg-white dark:bg-dark-card rounded-2xl border border-border dark:border-dark-border p-6">
            ...
            <p className="text-[14px] text-navy dark:text-dark-text leading-relaxed">
              Zdjęcia i wideo z drona DJI Mini 5 Pro. Eventy, architektura oraz tereny i obiekty firmowe. Mam certyfikat operatora A1/A3 i ubezpieczenie OC, więc loty nad Twoim obiektem są w pełni bezpieczne formalnie. Pełna oferta foto, wideo i dron w jednym zespole.
            </p>
          </div>
        </AnimatedSection>
      </div>
