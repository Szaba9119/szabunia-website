...
export const servicePillars = [
  // KOLEJNOŚĆ 22.09.2026 (decyzja Marcina): Wydarzenia → Ludzie → Obiekty → Produkty.
  // Strategia „event jest wejściem, sesja zespołowa zarobkiem” (07_Strategia/
  // korekta_pozycjonowania_2026-07.md). Ta tablica ustala kolejność kart na stronie
  // głównej (`Services.tsx`) i na `/uslugi`, razem z numeracją 01-04. Tę samą
  // kolejność mają: hasło i kolaż w `Hero.tsx`, stopka, lista usług w formularzu,
  // miniatury galerii w `Portfolio.tsx` i zakładki `/galeria`. URL-e i H1 bez zmian.
  { number: '01', label: 'Wydarzenia', slug: 'eventy-reportaze', formCode: 'event', question: 'Jak długo potrwa wydarzenie?', placeholder: 'np. konferencja od 9 do 17',
  ...
  { number: '02', label: 'Ludzie', slug: 'wizerunek-portrety', formCode: 'wizerunek', question: 'Ile osób planujesz sfotografować?', placeholder: 'np. 12 osób',
